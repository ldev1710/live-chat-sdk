package com.example.mifonelibproj.call;//package com.example.mifone_sdk.call;
//
...
//
//import com.example.mifone_sdk.R;
//import com.example.mifone_sdk.receiver.BluetoothReceiver;
//import com.example.mifone_sdk.receiver.HeadsetReceiver;
//import com.example.mifone_sdk.util.MifoneManager;
//import com.example.mifone_sdk.util.MifonePreferences;
//
...
//        if (!MifonePreferences.instance().isDeviceRingtoneEnabled()) {
...
//                    && mVibrator != null
//                    && MifonePreferences.instance().isIncomingCallVibrationEnabled()) {
...
//        if (MifoneContext.isReady()) MifoneManager.getCallManager().refreshInCallActions();
//    }
//
...
//            if ((permission.checkPermissions(new String[]{
